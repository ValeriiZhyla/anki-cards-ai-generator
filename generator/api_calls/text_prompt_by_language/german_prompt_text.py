...
Sie dürfen das Wort aus der Eingabe nicht im Ausgabe verwenden. Es sollte mit Unterstrichen maskiert sein.
...
anki_examples = {"verschlimmbessern": "Wenn man eine Situation durch Versuche der Verbesserung tatsächlich verschlechtert, hat man sie __________t"
                 ...
                 "die Einkunft": "Unter __________ versteht man den Geldbetrag, den jemand regelmäßig erhält, oft aus Arbeit, Geschäften oder Vermögenswerten. "
                                 "Diese kann aus verschiedenen Quellen stammen, wie Löhnen, Mieten, Zinsen oder Dividenden.  "
                                 "In der Buchhaltung wird __________ als Maß für den finanziellen Zugewinn einer Person oder Organisation gesehen. ",
                 "der Alptraum": "__________ ist ein besonders beängstigender oder stressiger Traum. "
                                 "Dieser Begriff kann auch metaphorisch verwendet werden, um eine sehr unangenehme oder schwierige Situation zu beschreiben. "
                                 "Im mittelalterlichen Glauben bezog sich __________ auf einen Dämon, der nachts auf der Brust der Schlafenden saß. "
                                 "Kinder und Erwachsene können __________ erleben, oft ausgelöst durch Stress oder Angst. ",
                 "die Steuererklärung": "Eine __________ ist ein offizielles Dokument, das an das Finanzamt gesendet wird, um Einkommen, Ausgaben und andere steuerrelevante Informationen eines Jahres zu melden. "
                                        "Durch das Einreichen einer __________ kann eine Person oder Firma ihre zu zahlenden Steuern berechnen oder eine Rückerstattung für zu viel gezahlte Beträge erhalten. "
                                        "Die Abgabe der __________ muss bis zu einem bestimmten Datum erfolgen, um Strafen oder Verzögerungen bei der Rückerstattung zu vermeiden. "
                                        "In vielen Ländern ist die elektronische Übermittlung der __________ durch Online-Steuerdienste möglich, was den Prozess vereinfacht und beschleunigt. "
                                        "Durch die __________ kann der Staat Einnahmen generieren, die zur Finanzierung öffentlicher Dienstleistungen und Infrastruktur verwendet werden. "
                 }
